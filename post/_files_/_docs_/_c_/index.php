...
<link rel="stylesheet" type="text/css" href="codepen.css"/>
 <section style="background-image: url('../../lib/assets/images/bg/1.png');" class="pb_cover_v1 overflow-hidden cover-bg-opacity-1 text-left pb_gradient_v1" id="section-home">
      <div class="container">
